...
//Figure out how to use the resetDisplay state property so that the user can start doing 
//other math operations when clicking on a number after pressing equals.  
  setDisplay(num) {
    var display;
